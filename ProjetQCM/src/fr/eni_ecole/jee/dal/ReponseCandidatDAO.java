	...
	public static ArrayList<ReponseCandidat> getReponsesByInscription(int numInscription) throws SQLException
	{
		...
		try
		{
			...
			while (rsQuestion.next())
			{
				...
				Question laQuestion = new Question(rsQuestion.getInt("id"), rsQuestion.getInt("id_theme"), rsQuestion.getString("enonce"), rsQuestion.getBoolean("type_reponse"), rsQuestion.getString("image"));
